...
double spl (double *r, double *r0, double q, double l)							
{
  ...
  if ( (rpp[1]==0) && (rpp[2]==0) )
    return ((q/l)/(4.0*pi*ep))*(((x1/fabs(x1))*log(2*fabs(x1))) - (x2/fabs(x2))*log(2*fabs(x2)));
  if (x1==l/2)
    return ((q/l)/(4.0*pi*ep))*((   asinh((x2)/(sqrt(rpp[1]*rpp[1] + rpp[2]*rpp[2])))));
  if (x2==-l/2)
    return ((q/l)/(4.0*pi*ep))*(( - asinh((x1)/(sqrt(rpp[1]*rpp[1] + rpp[2]*rpp[2])))));	
...
double FVV (double xpp, double ypp, double zpp)
{
  ...
  if ((ax<n)&&(ay<n))
    {
      //cout << "1 " <<  /*1*/(a/60)*(pow(x2+y2+z2,2.0) - 5*(x2*y2 + x2*z2 + y2*z2)) << endl; 
      return + /*1*/(a/60)*(pow(x2+y2+z2,2.0) - 5*(x2*y2 + x2*z2 + y2*z2));
    } 

  if ((ax<n)&&(az<n))
    {
      //cout << "2 " << + /*1*/(a/60)*(pow(x2+y2+z2,2.0) - 5*(x2*y2 + x2*z2 + y2*z2)) << endl; 
      return + /*1*/(a/60)*(pow(x2+y2+z2,2.0) - 5*(x2*y2 + x2*z2 + y2*z2));
    }

  if ((ay<n)&&(az<n))
    {
      //cout << "3 " << + /*1*/(a/60)*(pow(x2+y2+z2,2.0) - 5*(x2*y2 + x2*z2 + y2*z2)) << endl; 
      return + /*1*/(a/60)*(pow(x2+y2+z2,2.0) - 5*(x2*y2 + x2*z2 + y2*z2));
    } 

  if (ax<n)
    {
      //cout << "4 " << + /*1*/(a/60)*(pow(x2+y2+z2,2.0) - 5*(x2*y2 + x2*z2 + y2*z2)) + /*8*/(ypp*z4/12)*log(x2 + z2) + /*10*/(y4*zpp/12)*log(x2 + y2)	- /*25*/((ypp*z4)/48)*log(pow(y2 + z2 + ypp*a,2.0) + x2*z2)	- /*26*/((y4*zpp)/48)*log(pow(y2 + z2 + zpp*a,2.0) + x2*y2) <<endl;
  ...
  if (ay<n)
    {
      //cout <<"5 "<< + /*1*/(a/60)*(pow(x2+y2+z2,2.0) - 5*(x2*y2 + x2*z2 + y2*z2)) + /*9*/(x4*zpp/8)*log(x2 + y2) + /*12*/(xpp*z4/48)*log(y2 + z2) + /*15*/(x4*zpp/12)*asinh(zpp/sqrt(x2+y2))	- /*23*/((xpp*z4)/48)*log(pow(x2 + z2 + xpp*a,2.0) + y2*z2) - /*24*/((x4*zpp)/16)*log(pow(x2 + z2 + zpp*a,2.0) + x2*y2) <<endl;
  ...
  if (az<n)
    {
      //cout << "6 " << endl;cout << - /*22*/((x4*ypp)/16)*log(pow(x2 + y2 + ypp*a,2.0) + x2*z2)<< " " << ((x4*ypp)/16) << " " << pow(x2 + y2 + ypp*a,2.0) << " " << x2 + y2 + (ypp*a) << " " << x2*z2 << 								" " << - /*22*/(x4*ypp)*log(xpp + ypp + ypp*a + xpp*zpp) << " " << xpp + ypp + ypp*a + xpp*zpp << endl; 
      ...
      if((x2 + y2 + xpp*a<n)&&(x2 + y2 + ypp*a<n))
	{
      ...
      if(x2 + y2 + xpp*a<n)
	{
	  //cout << "6a " << + /*14*/(xpp*y4/12)*asinh(xpp/sqrt(y2+z2)) <<  " " << xpp << " " << a <<  " " << (xpp*y4/12)*asinh(xpp/sqrt(y2+z2)) << endl;
